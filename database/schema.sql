...
CREATE TABLE IF NOT EXISTS project_reports (
  ...
  risks TEXT,
  change_note TEXT,
  change_observation MEDIUMTEXT,
  analysis_detail MEDIUMTEXT,
  previous_report_id INT UNSIGNED DEFAULT NULL,
  star_growth INT DEFAULT NULL,
  fork_growth INT DEFAULT NULL,
  span_days INT DEFAULT NULL,
...
INSERT IGNORE INTO app_settings (setting_key, setting_value, description, updated_at)
VALUES ('deepseek_api_key', '', 'DeepSeek API Key（优先于 GitHub Secrets）', NOW());

INSERT IGNORE INTO app_settings (setting_key, setting_value, description, updated_at)
VALUES ('deepseek_base_url', '', 'DeepSeek API 地址（优先于 GitHub Secrets）', NOW());

INSERT IGNORE INTO app_settings (setting_key, setting_value, description, updated_at)
VALUES ('deepseek_model', '', 'DeepSeek 模型名（优先于 GitHub Secrets）', NOW());
